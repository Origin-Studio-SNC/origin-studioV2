...
const ProjectsSection = () => {
  ...
  return (
    <section
      id="realisations"
      className="bg-muted/30 px-6 py-[130px] lg:px-40"
    >
      <div className="mx-auto max-w-7xl">
        <p className="section-label mb-16">Projets</p>
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-10">
          ...
          <article className="group relative aspect-4/3 overflow-hidden rounded-sm border border-border bg-card md:col-span-6 md:aspect-auto md:min-h-[520px]">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              ...
              <h4 className="text-3xl font-light">{featured.title}</h4>
            </div>
          </article>
        ...
        <div className="mt-20 grid grid-cols-2 gap-4 md:grid-cols-4">
          {stats.map((s) => (
            <div
              key={s.label}
              className="border border-border bg-card/50 p-8"
            >
